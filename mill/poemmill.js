...
const Bfile = `${bookid}B.js`;
const tools = require("./tools.js");
const poems = require("./fieldnotespoems.js");
const npoems = poems.length;
const bookwidth = 8.5;
const bookheight = 8.5;
const bookmargin = 1;
const width = bookwidth+"in";
const height = bookheight+"in";
const w = Number(bookwidth), h = Number(bookheight);
const m = Number(bookmargin);
const iw = (w-2.0*m);
const ih = (h-2.0*m);
const innerwidth = iw+"in";
const innerheight = ih+"in";
const margin = bookmargin+"in";
const margingutter = (m+0.2)+"in";
const svgwidth = iw*300;
const svgheight = ih*300;
