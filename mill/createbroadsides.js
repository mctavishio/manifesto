...
<head>
	...
	<link rel="stylesheet" media="print" href="css/bookbroadsides.css"/>
	<style>
	@media only screen  {
		body {
...
let filename = `${book.file}bweb.html`;
fs.writeFileSync(filename, html, (err) => {
  if (err)
    console.log(err);
  else {
    console.log(`${filename} written successfully\n`);
	console.log(`${book.file}broadsides.pdf make next`);
  }
});
console.log(`prince ${filename}.html -o ${book.file}broadsides.pdf`);
